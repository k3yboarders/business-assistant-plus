    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxationType", x => x.TaxationTypeId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypeOfActivity", x => x.TypeOfActivityId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_TaxationType_TaxationTypeId",
                        column: x => x.TaxationTypeId,
                        principalTable: "TaxationType",
                        principalColumn: "TaxationTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_TypeOfActivity_TypeOfActivityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TaxationTypeId",
                table: "AspNetUsers",
                column: "TaxationTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_TypeOfActivityId",
                table: "AspNetUsers",
